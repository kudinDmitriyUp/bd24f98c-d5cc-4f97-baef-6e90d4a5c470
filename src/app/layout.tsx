...
export const metadata: Metadata = {
  title: "Osteria delle Coppelle - Authentic Roman Cuisine",
  description: "Experience authentic Roman cuisine at Osteria delle Coppelle. Traditional Italian dishes prepared with passion since 1983. Reserve your table today.",
  keywords: "Roman restaurant, Italian cuisine, authentic pasta, Rome dining, Italian food",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Osteria delle Coppelle - Authentic Roman Cuisine",
    description: "Experience authentic Roman cuisine at Osteria delle Coppelle. Traditional Italian dishes prepared with passion since 1983.",
    type: "website",
    siteName: "Osteria delle Coppelle"
  }
};
